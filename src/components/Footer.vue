        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-5 mb-4">
                    ...
                    <p>
                        Menjual berbagai pakaian distro mulai dari kaos, kemeja, Jaket, Celana panjang dan pendek.
                    </p>
                    <div class="social">
                ...
                <div class="col-md-4 mb-4">
                    ...
                    <p>
                        ...
                        <br>
                        Senin - Minggu ( 09.00 s/d 22.00 )
                    </p>
                    <p>
                        <i class="fa fa-map-marker"></i> Jl. Suwignyo (deretan almadinah herbal)
                    </p>
                </div>
            </div>
            <div class="row text-center mt-3 pb-3">
                <div class="col-md-12">
                    <hr>
                    © <strong>Surya Jeans Store</strong> 2023 • Hak Cipta Dilindungi
                </div>
            </div>
        </div>
    </footer>
